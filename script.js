...
function playPostEscapeWinLines(onComplete, position = "center") {
    ...
    function showNext() {
        ...
        if (i === lines.length - 1) {
            startText.innerHTML = `THANK YOU FOR PLAYING<br>
                <a href="https://github.com/wattanunteeratanapong/Dont-Deal-With-The-Devil" 
                target="_blank" 
                style="color: white; text-decoration: underline; line-height: 1.2em;">
                View on GitHub
                </a>`;
